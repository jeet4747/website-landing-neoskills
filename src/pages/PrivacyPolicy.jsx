      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm border p-8 space-y-6 text-gray-700 leading-relaxed">
            ...
            <p>For privacy-related inquiries, contact us at <a href="mailto:contact@neoskills.co.in" className="text-primary font-medium">contact@neoskills.co.in</a> or call <a href="tel:+918087020031" className="text-primary font-medium">+91 8087020031</a>.</p></section>
          </div>
        </div>
      </div>
    </>
