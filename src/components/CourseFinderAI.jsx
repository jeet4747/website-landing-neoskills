...
const allCourses = [
  ...
  { keywords: ['servicenow admin', 'service now admin', 'servicenow administrator'], title: 'ServiceNow Admin', cat: 'IT Service' },
  { keywords: ['servicenow developer', 'service now developer', 'servicenow cad'], title: 'ServiceNow Developer', cat: 'IT Service' },
  { keywords: ['servicenow admin and developer', 'service now admin and developer'], title: 'ServiceNow Admin & Developer', cat: 'IT Service' },
